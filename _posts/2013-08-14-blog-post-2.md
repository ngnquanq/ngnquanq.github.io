...
![gmlp_attention_matrix](/assets/img/blog2/gmlp_attention_matrix.png)

Thì như cái hình này, mình có thể thấy được là ma trận $W$ này của cái phần SGU cũng có thể show ra sự liên hệ giữa mấy cái từ với nhau mà không cần thông qua cơ chế attention
